...
return [
    ...
    [ // $staticRoutes
        '/admin' => [
            [['_route' => 'admin_dashboard', '_controller' => 'App\\Controller\\Admin\\DashboardController::index'], null, null, null, false, false, null],
        ...
        '/single/product' => [[['_route' => 'app_single_product', '_controller' => 'App\\Controller\\SingleProductController::index'], null, null, null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
